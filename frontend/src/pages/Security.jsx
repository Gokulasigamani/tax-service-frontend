...
function MetricCard({ title, value, footer }) {
  return (
    <div className="bg-surface p-4 sm:p-5 rounded-xl sm:rounded-2xl border border-border shadow-sm min-h-[110px]">

      <p className="text-xs sm:text-sm text-text-main/70 mb-2">
        {title}
      </p>
...
export default function AutomationHub() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3 text-xs text-text-main/70">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          {workflows.map((wf, i) => (
            ...
            >
              ...
              {/* Flow */}
              <div className="text-sm text-text-main/70 space-y-2">
              ...
              <div className="text-xs text-text-main/50 flex items-center gap-1">
                <Clock size={12} />
                Last run {wf.lastRun}
              </div>
        ...
        <div className="bg-surface rounded-xl border border-border shadow-sm p-4 sm:p-5 space-y-4">
          ...
          {[
            ...
            <div key={i} className="text-sm text-text-main/70 bg-surface p-2 rounded">
              {log}
            </div>
          ))}
      ...
      <div className="bg-surface rounded-xl border border-border shadow-sm p-4 sm:p-5 space-y-3">
        ...
        <div className="bg-blue-500/10 text-blue-500 p-3 rounded-lg text-sm">
          Trigger alerts for failed document processing
        </div>

        <div className="bg-emerald-500/10 text-emerald-500 p-3 rounded-lg text-sm">
