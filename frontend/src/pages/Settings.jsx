    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white rounded-xl border border-neutral-200 shadow-sm p-4 sm:p-5 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-neutral-50 rounded-lg p-3">
      ...
      <div className="flex justify-end">
        ...
        <button className="w-full sm:w-auto px-6 py-2 rounded-lg bg-violet-600 text-white text-sm hover:bg-violet-700 transition shadow-sm">
          Save Changes
        </button>
