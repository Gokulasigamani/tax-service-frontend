  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 w-full max-w-md">
        ...
        >
          <PanelLeft size={20} className="text-neutral-600" />
        </button>
      ...
      <div className="flex items-center gap-4">
        ...
        <button
          ...
          px-4 py-2 rounded-lg border border-violet-200
          bg-white text-sm font-medium text-violet-700
          shadow-sm hover:bg-violet-50 transition"
        >
          <Wand2 size={16} />
          Create
        </button>
